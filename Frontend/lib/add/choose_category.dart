...
List<categoryTemplate> categories = [
    ...
    categoryTemplate(label: 'Bills',icon: Icons.payment,card_color: Colors.green[50]),
    categoryTemplate(label: 'Rent',icon: Icons.home, card_color:Colors.green[50]),
    categoryTemplate(label: 'Food',icon: Icons.fastfood, card_color:Colors.green[50]),
    categoryTemplate(label: 'Social Life',icon: Icons.local_bar, card_color:Colors.green[50]),
    categoryTemplate(label: 'Entertainment',icon: Icons.music_note, card_color:Colors.green[50]),
    categoryTemplate(label: 'Household',icon: Icons.local_grocery_store, card_color:Colors.green[50]),
    categoryTemplate(label: 'Pharmacy',icon: Icons.healing, card_color:Colors.green[50]),
    categoryTemplate(label: 'Transportation',icon: Icons.airport_shuttle, card_color:Colors.green[50]),
    categoryTemplate(label: 'Personal Development',icon: Icons.person, card_color:Colors.green[50]),
    others_category,
    add_category
